...
namespace TensorSharp.CUDA
{
    ...
    public class CudaRandom
    {
        ...
        {
            using var cpuCopy = new Tensor(this.cpuAllocator, result.ElementType, result.Sizes);
            this.cpuRandom.Uniform(cpuCopy, seed, min, max);
        ...
        {
            using var cpuCopy = new Tensor(this.cpuAllocator, result.ElementType, result.Sizes);
            this.cpuRandom.Normal(cpuCopy, seed, mean, stdv);
            Ops.Copy(result, cpuCopy);
        }
        ...
        {
            using var cpuCopy = new Tensor(this.cpuAllocator, result.ElementType, result.Sizes);
            this.cpuRandom.Exponential(cpuCopy, seed, lambda);
            Ops.Copy(result, cpuCopy);
        }
        ...
        {
            using var cpuCopy = new Tensor(this.cpuAllocator, result.ElementType, result.Sizes);
            this.cpuRandom.Cauchy(cpuCopy, seed, median, sigma);
            Ops.Copy(result, cpuCopy);
        }
        ...
        {
            using var cpuCopy = new Tensor(this.cpuAllocator, result.ElementType, result.Sizes);
            this.cpuRandom.LogNormal(cpuCopy, seed, mean, stdv);
            Ops.Copy(result, cpuCopy);
        }
        ...
        {
            using var cpuCopy = new Tensor(this.cpuAllocator, result.ElementType, result.Sizes);
            this.cpuRandom.Geometric(cpuCopy, seed, p);
            Ops.Copy(result, cpuCopy);
        }
        ...
        {
            using var cpuCopy = new Tensor(this.cpuAllocator, result.ElementType, result.Sizes);
            this.cpuRandom.Bernoulli(cpuCopy, seed, p);
            Ops.Copy(result, cpuCopy);
        }
    }
}
